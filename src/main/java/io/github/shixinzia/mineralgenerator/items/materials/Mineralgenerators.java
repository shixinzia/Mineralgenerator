...
public class Mineralgenerators extends SlimefunItem {
    ...
    public Mineralgenerators(ItemGroup category, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, int defaultRate) {
        super(category, item, recipeType, recipe);
        this.rate = new IntRangeSetting(this, "rate", 1, defaultRate, 1000);
    ...
    public final Mineralgenerators setItem(@Nonnull Material material) {
